# app.py - FINAL HARDENED AND VERIFIED VERSION
...
try:
    ...
    st.error("Authentication configuration file (`config.yaml`) not found. Please ensure it is in your GitHub repository.")
    st.stop()
